...
const BasePaginator = (props: BasePaginatorProps) => {
    const { totalRecords, pageLimit, pageNeighbours, ariaLabel, pageChangeHandler: onPageChange, currentPage } = props;
        ...
        <Fragment>
            <Pagination aria-label={ariaLabel} size="sm">
                <PaginationItem className={`page-item ${sanitizedCurrentPage > 1 ? '' : 'disabled'}`}>
                    <PaginationLink className={`page-link`} href="#" aria-label={startLabel} onClick={handleClick(1)}>
                ...
                <PaginationItem className={`page-item  ${sanitizedCurrentPage < totalPages ? '' : 'disabled'}`}>
                    <PaginationLink className={`page-link`} href="#" aria-label={nextLabel} onClick={handleMoveRight}>
