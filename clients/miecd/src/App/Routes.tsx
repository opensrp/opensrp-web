            ...
            <div className="content">
                <Switch>
                    <LastLocationProvider>
                        <ConnectedPrivateRoute disableLoginProtection={false} exact={true} path="/" component={Home} />
                        ...
                        <ConnectedPrivateRoute
                            ...
                            // tslint:disable-next-line: jsx-no-lambda
                            component={(routeProps: any) => <ConnectedPatientDetails isChild={true} {...routeProps} />}
                        />
                        <ConnectedPrivateRoute
                            disableLoginProtection={false}
                            exact={true}
