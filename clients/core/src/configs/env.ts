...
/** form config */
export const ENABLE_VIEW_RELEASE_PAGE = process.env.REACT_APP_ENABLE_VIEW_RELEASE_PAGE === 'true';
export type ENABLE_VIEW_RELEASE_PAGE = typeof ENABLE_VIEW_RELEASE_PAGE;

export const ENABLE_VIEW_JSON_VALIDATORS_PAGE = process.env.REACT_APP_ENABLE_VIEW_JSON_VALIDATORS_PAGE === 'true';
export type ENABLE_VIEW_JSON_VALIDATORS_PAGE = typeof ENABLE_VIEW_JSON_VALIDATORS_PAGE;

export const ENABLE_VIEW_DRAFT_FILES_PAGE = process.env.REACT_APP_ENABLE_VIEW_DRAFT_FILES_PAGE === 'true';
export type ENABLE_VIEW_DRAFT_FILES_PAGE = typeof ENABLE_VIEW_DRAFT_FILES_PAGE;
