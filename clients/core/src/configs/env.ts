...
export const OPENSRP_LOCATION_CREATE_ENDPOINT = process.env.REACT_APP_OPENSRP_LOCATION_CREATE_ENDPOINT || 'location?is_jurisdiction=true';
export type OPENSRP_LOCATION_CREATE_ENDPOINT = typeof OPENSRP_LOCATION_CREATE_ENDPOINT;
export const OPENSRP_LOCATION_TAG_ENDPOINT = process.env.REACT_APP_OPENSRP_LOCATION_ENDPOINT || 'location-tag';
export type OPENSRP_LOCATION_TAG_ENDPOINT = typeof OPENSRP_LOCATION_TAG_ENDPOINT;
