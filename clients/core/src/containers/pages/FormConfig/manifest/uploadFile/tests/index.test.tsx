...
import { fetchManifestFiles, filesReducerName, manifestFilesReducer, ManifestFilesTypes } from '@opensrp/form-config';
...
import { MANIFEST_FILE_UPLOAD, RELEASES_LABEL, VIEW_RELEASE_PAGE_URL } from '../../../../../../constants';
