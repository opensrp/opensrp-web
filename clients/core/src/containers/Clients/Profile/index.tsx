...
import { Col, Container, Row, Table, FormGroup, Input, Nav, NavItem, NavLink, TabContent, TabPane } from 'reactstrap';
import './childProfile.css';
import classnames from 'classnames';

class ClientProfile extends React.Component<any, any> {
    render() {
        return (
