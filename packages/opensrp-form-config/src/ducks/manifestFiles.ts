...
const reducer = reducerFactory<ManifestFilesTypes>(filesReducerName);

// action
/** fetch manifest files to store action */
export const fetchManifestFiles = fetchActionCreatorFactory<ManifestFilesTypes>(filesReducerName, 'id');
