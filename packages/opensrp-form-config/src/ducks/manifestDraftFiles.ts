...
const draftReducer = reducerFactory<ManifestFilesTypes>(draftReducerName);

// action
/** fetch manifest draft files to store action */
export const fetchManifestDraftFiles = fetchActionCreatorFactory<ManifestFilesTypes>(draftReducerName, 'id');
