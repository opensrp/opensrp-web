...
declare const filesReducer: (state: import("@opensrp/reducer-factory/dist/types").ImmutableObjectState<ManifestFilesTypes> | undefined, action: import("@opensrp/reducer-factory/dist/types").ItemsActionTypes<ManifestFilesTypes>) => import("@opensrp/reducer-factory/dist/types").ImmutableObjectState<ManifestFilesTypes>;
