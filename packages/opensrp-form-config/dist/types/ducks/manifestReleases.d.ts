...
declare const releasesReducer: (state: import("@opensrp/reducer-factory/dist/types").ImmutableObjectState<ManifestReleasesTypes> | undefined, action: import("@opensrp/reducer-factory/dist/types").ItemsActionTypes<ManifestReleasesTypes>) => import("@opensrp/reducer-factory/dist/types").ImmutableObjectState<ManifestReleasesTypes>;
