...
declare const ConnectedManifestDraftFiles: import("react-redux").ConnectedComponent<{
    ...
    /** pass default props to component */
    defaultProps: DefaultProps;
}, Pick<ManifestDraftFilesProps, "placeholder" | "debounceTime" | "downloadEndPoint" | "manifestEndPoint" | "releasesUrl" | "baseURL" | "endpoint" | "getPayload" | "growl" | "LoadingComponent">>;
