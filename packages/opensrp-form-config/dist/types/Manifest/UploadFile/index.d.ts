...
declare const ConnectedUploadConfigFile: import("react-redux").ConnectedComponent<{
    (props: UploadConfigFileProps & DefaultProps): JSX.Element;
    defaultProp: DefaultProps;
}, Pick<UploadConfigFileProps & DefaultProps, "isJsonValidator" | "baseURL" | "endpoint" | "getPayload" | "growl" | "LoadingComponent" | "draftFilesUrl" | "formId" | "validatorsUrl"> & UploadConfigFileProps>;
