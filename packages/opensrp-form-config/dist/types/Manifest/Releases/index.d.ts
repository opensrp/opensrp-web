...
declare const ConnectedManifestReleases: import("react-redux").ConnectedComponent<{
    ...
    /** pass default props to component */
    defaultProps: DefaultProps;
}, Pick<ManifestReleasesProps & DefaultProps, "placeholder" | "debounceTime" | "baseURL" | "endpoint" | "getPayload" | "growl" | "LoadingComponent" | "uploadTypeUrl" | "formUploadUrl" | "currentUrl">>;
