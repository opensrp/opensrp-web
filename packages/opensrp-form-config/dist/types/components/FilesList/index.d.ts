...
declare const ConnectedManifestFilesList: import("react-redux").ConnectedComponent<{
    ...
    /** pass default props to component */
    defaultProps: DefaultProps;
}, Pick<ManifestFilesListProps, "isJsonValidator" | "placeholder" | "debounceTime" | "baseURL" | "endpoint" | "getPayload" | "growl" | "LoadingComponent" | "uploadTypeUrl" | "downloadEndPoint" | "formVersion" | "fileUploadUrl">>;
