...
export function getLocChildren(state: Partial<Store>, locId: string): string[] {
    return (state as any)[locationReducerName].locations.parentChildren[locId] || [];
}
...
export function getActiveLocId(state: Partial<Store>): string {
    return (state as any)[locationReducerName].locations.activeLocId || null;
}
...
export function getDefaultLocId(state: Partial<Store>): string {
    return (state as any)[locationReducerName].locations.defaultLocId || null;
}
...
export function getSelectedLocs(state: Partial<Store>): string[] {
    return (state as any)[locationReducerName].locations.selectedLocs || [];
}
