...
export const SUPERSET_PREGNANCY_ANALYSIS_ENDPOINT =
  process.env.REACT_APP_SUPERSET_ANALYSIS_ENDPOINT || '';
export type SUPERSET_PREGNANCY_ANALYSIS_ENDPOINT = typeof SUPERSET_PREGNANCY_ANALYSIS_ENDPOINT;

export const REACT_APP_SUPERSET_SMS_DATA_SLICE =
  process.env.REACT_APP_SUPERSET_SMS_DATA_SLICE || '0';
export type REACT_APP_SUPERSET_SMS_DATA_SLICE = typeof REACT_APP_SUPERSET_SMS_DATA_SLICE;
