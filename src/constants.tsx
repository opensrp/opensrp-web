...
export const BACK_TO_PREGNANCY_FROM_LOGFACE = 'Back to Pregnancy Log Face';
export type BACK_TO_PREGNANCY_FROM_LOGFACE = typeof BACK_TO_PREGNANCY_FROM_LOGFACE;
