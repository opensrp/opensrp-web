...
export const OVERWEIGHT_CAPITALIZED = 'Overweight';
export type OVERWEIGHT_CAPITALIZED = typeof OVERWEIGHT_CAPITALIZED;
export const OVERWEIGHT = 'overweight';
export type OVERWEIGHT = typeof OVERWEIGHT;
export const STUNTED_CAPITALIZED = 'Stunted';
export type STUNTED_CAPITALIZED = typeof STUNTED_CAPITALIZED;
export const STUNTED = 'stunted';
export type STUNTED = typeof STUNTED;
export const SEVERE_WASTING_CAPITALIZED = 'Severe Wasting';
export type SEVERE_WASTING_CAPITALIZED = typeof SEVERE_WASTING_CAPITALIZED;
export const SEVERE_WASTING = 'severe wasting';
export type SEVERE_WASTING = typeof SEVERE_WASTING;
export const INAPPROPRIATELY_FED_CAPITALIZED = 'Inappropriately Fed';
export type INAPPROPRIATELY_FED_CAPITALIZED = typeof INAPPROPRIATELY_FED_CAPITALIZED;
...
export const LOG_FACE_LOWER = 'Log face';
export type LOG_FACE_LOWER = typeof LOG_FACE_LOWER;
export const LOG_FACE = 'Log Face';
export type LOG_FACE = typeof LOG_FACE;
...
export const CHILD_AGE = 'Age';
export type CHILD_AGE = typeof CHILD_AGE;
export const RESIDENCE = 'Location of residence';
...
export const CHILD_WEIGHT = 'Child Weight';
export type CHILD_WEIGHT = typeof CHILD_WEIGHT;
export const CHILD_HEIGHT = 'Child Height';
export type CHILD_HEIGHT = typeof CHILD_HEIGHT;
export const CHILD_HEIGHT_MONITORING = 'Child Height Monitoring';
export type CHILD_HEIGHT_MONITORING = typeof CHILD_HEIGHT_MONITORING;
...
export const HEALTH_WORKER_NAME = 'health_worker_name';
